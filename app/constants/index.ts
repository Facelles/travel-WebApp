...
// Define a local AxisModel to avoid depending on '@syncfusion/ej2-react-charts' type declarations
type AxisModel = {
  valueType?: string;
  title?: string;
  minimum?: number;
...
export const dashboardStats = {
  totalUsers: 12450,
  usersJoined: { lastMonth: 350, currentMoth: 756 },
  totalTrips: 5420,
  tripsCreated: { lastMonth: 120, currentMoth: 80 },
  userRole: { total: 62, currentMoth: 15, lastMonth: 7 },
};
